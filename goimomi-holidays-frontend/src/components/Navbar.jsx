...
import logo from '../assets/goimomi.png'

const Navbar = () => {
  const [mobileOpen, setMobileOpen] = React.useState(false)

  const navLinkClass =
    'flex flex-col items-center justify-center text-xs hover:text-goimomi-primary'
    ...
    <header className="w-full">
      ...
      <div className="border-b sticky top-0 bg-white z-50">
        <div className="max-w-8xl mx-auto flex items-center justify-between px-4 py-3">
          {/* Logo */}
          <Link to="/">
            <img src={logo} alt="Goimomi Holidays" className="h-16" />
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-6 text-slate-800">
            ...
            <NavLink to="/visa" className={navLinkClass}>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-56 rounded-xl border border-slate-100 bg-white text-slate-700 shadow-xl opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition">
            ...
            <NavLink
              to="/about"
              className={({ isActive }) =>
                `text-sm font-medium hover:text-goimomi-primary ${
                  isActive ? 'text-goimomi-primary' : ''
                }`
              }
            >
